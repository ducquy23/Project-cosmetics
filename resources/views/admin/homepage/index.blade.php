                ...
                <div class="card-body p-4">
                    ...
                    <div class="table-responsive">
                        <table class="table text-nowrap mb-0 align-middle">
                            ...
                            <tr>
                                <td class="border-bottom-0">
                                    <h6 class="fw-semibold mb-0">Nội dung Sản phẩm Bán chạy</h6>
                                </td>
                                <td class="border-bottom-0">
                                    <span class="mb-0">Quản lý nội dung text và link của block sản phẩm bán chạy</span>
                                </td>
                                <td class="border-bottom-0 text-center">
                                    <span class="mb-0">{{ $sections->get('best_selling_content', collect())->count() }}</span>
                                </td>
                                <td class="border-bottom-0 text-center">
                                    <a href="{{ route('admin.homepage.edit', 'best_selling_content') }}" class="btn btn-primary btn-sm">Sửa</a>
                                </td>
                            </tr>
                            <tr>
                                <td class="border-bottom-0">
                                    <h6 class="fw-semibold mb-0">Testimonial (Đánh giá khách hàng)</h6>
                                </td>
                                <td class="border-bottom-0">
                                    <span class="mb-0">Quản lý các đánh giá, nhận xét của khách hàng</span>
                                </td>
                                <td class="border-bottom-0 text-center">
                                    <span class="mb-0">{{ $sections->get('testimonial', collect())->count() }}</span>
                                </td>
                                <td class="border-bottom-0 text-center">
                                    <a href="{{ route('admin.homepage.edit', 'testimonial') }}" class="btn btn-primary btn-sm">Sửa</a>
                                </td>
                            </tr>
                            <tr>
                                <td class="border-bottom-0">
                            ...
                            <tr>
                                <td class="border-bottom-0">
                                    <h6 class="fw-semibold mb-0">Banner (Top)</h6>
                                </td>
                                <td class="border-bottom-0">
                                    <span class="mb-0">Quản lý các banner hiển thị ở phần trên trang chủ (2 banner)</span>
                                </td>
                                <td class="border-bottom-0 text-center">
                            ...
                            <tr>
                                <td class="border-bottom-0">
                                    <h6 class="fw-semibold mb-0">Banner (Bottom)</h6>
                                </td>
                                <td class="border-bottom-0">
                                    <span class="mb-0">Quản lý các banner hiển thị ở phần dưới trang chủ (2 banner)</span>
                                </td>
                                <td class="border-bottom-0 text-center">
                                    <span class="mb-0">{{ $sections->get('banner_bottom', collect())->count() }}</span>
                                </td>
                                <td class="border-bottom-0 text-center">
                                    <a href="{{ route('admin.homepage.edit', 'banner_bottom') }}" class="btn btn-primary btn-sm">Sửa</a>
                                </td>
                            </tr>
                            <tr>
                                <td class="border-bottom-0">
