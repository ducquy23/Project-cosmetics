            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{route('product.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name" id="name" onkeyup="generateSlug(this.value)">
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="slug" id="slug" placeholder="Tự động tạo từ tên sản phẩm">
