            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{route('post.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" class="form-control" id="title" onkeyup="generateSlug(this.value)">
                        @error('title')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="slug" class="form-control" id="slug" placeholder="Tự động tạo từ tiêu đề">
