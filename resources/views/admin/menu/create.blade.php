...
@section('content')
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title fw-semibold mb-4">Thêm Menu</h5>
                <form method="POST" action="{{route('menu.store')}}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="url" class="form-control" id="url" value="{{old('url')}}" placeholder="VD: /gioi-thieu hoặc https://example.com">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="route" class="form-control" id="route" value="{{old('route')}}" placeholder="VD: home, shop, about, category">
