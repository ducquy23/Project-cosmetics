...
@section('content')
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title fw-semibold mb-4">Chỉnh sửa Banner / Slide</h5>
                <form action="{{route('banner.update', $banner)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        @if($banner->image)
                            <div class="mt-2">
                                ...
                                <img src="{{asset('storage/' . $banner->image)}}" alt="{{$banner->title}}" class="rounded-1" style="max-width: 300px;">
                            </div>
                        @endif
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control" name="link" id="link" value="{{old('link', $banner->link)}}" placeholder="https://example.com">
                        @error('link')
                            <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
